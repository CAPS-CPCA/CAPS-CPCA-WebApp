...
const modules = [
...

    {
        ...
        content: [
            ...
            '<ul>',
            '<li>Explore the willingness to provide MA among all staff, address their concerns and determine how to best incorporate abortion services into your practice <a class="in" href="https://caps.sogc.org/prescribing/#3" >(see the next module)</a>.',
            '</ul>',
