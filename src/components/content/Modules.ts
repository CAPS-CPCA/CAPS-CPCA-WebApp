...
const modules = [
...

    {
        ...
        '<ol>',
                '<li>Confirm patient identity and ensure patient has privacy and safety to discuss.',
                ...
                '<li>Schedule a first virtual visit via telephone or video.',
        '</ol>',  
        ],
    },

    {
        ...
        '<ol>',
                '<li><strong>Review pregnancy options counselling.</strong>',
                ...
                '<ul>',
                    '<li>According to <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C14.pdf" >SOGC’s protocol on medication abortion</a> via telemedicine, ultrasound should be obtained if LMP is uncertain, LMP is over 70 days, and the signs, symptoms and risk factors of ectopic pregnancy (EP) are present.',
                ...
                '<ul>',
                    '<li>According to Health Canada, hemoglobin should be over 9.5 g / dL before starting MA.',
                    '<li>Screen patients for increased risk of anemia through a detailed medical history.',
                    '<li>If patients are suspected to have an increased risk of anemia, complete blood count is indicated. Otherwise, measuring hemoglobin is unnecessary.',
                '</ul>',
                ...
                '<ul>',
                    '<li>As explained elsewhere, guidelines on Rh status have been updated and vary between organizations.',
                ...
                '<ul>',
                    '<li>Offer testing for chlamydia and gonorrhea if patients come to office.',
                    '<li>Otherwise, evaluate the risk of STIs and consider remote testing if risk factors are present, and discuss the potential need for antibiotic treatment.',
                '</ul>',
        '</ol>',
        ],
    },
