  ...
  en: [
    ...
    },
    {
      ...
      content: [
        ...
        '<ul><li><b>Review pregnancy options</b> when indicated: abortion, becoming a parent or child adoption.',
        ...
        '<li><b>Use non-judgmental and inclusive language.</b></ul>',
        ...
        '<li><b>Discuss the patient’s eligibility for medication abortion</b>, including gestational age and medical history.',
        '<li><b>Discuss the patient’s access to pharmacies, telephone, transportation, emergency care, and labs and imaging facilities</b> if needed.',
        '<li>Discuss <a class="in" href="https://caps.sogc.org/prescribing/#1" target="_blank">the patient’s preferences and circumstances</a>, such as a safe place in their living situation to complete medication abortion. Share decision tools such as  <b><a class="ex" href="https://www.sexandu.ca/its-my-choice/" target="_blank">It’s My Choice</a></b> to help the patient choose the type of abortion that fits them.',
        '<li>Confirm that the decision is the patient’s own, reached without coercion.',
        '<li>Confirm the patient’s understanding that <b>medication abortion is irreversible</b> and that the patients must take an additional dose of the second medication or undergo procedural abortion in case of ongoing pregnancy.',
...

    {
      ...
      content: [
        ...
        '<li>Do not want to disclose the pregnancy and the abortion to those patients live with (such as partners, roommates, co-workers), as it might be difficult to conceal heavy bleeding and b cramps.</ul>',
      ],
      images: [
        {
          title: 'Abortion Options',
...

    {
      ...
      content: [
        ...
        '<ol><li><b>Obtain written or verbal informed consent</b> (see examples by <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C78.pdf" target="_blank">CAPS-CPCA platform</a> and the <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C83.pdf" target="_blank">Bay Center for Birth Control</a>) and document it in the patients’ chart.',
        '<li><b>Prescribe:</b>',
        ...
        '<li>Discuss post-abortion contraception options. <b>Emphasize that patients can quickly return to fertility following the abortion.</b>',
        '<li><b>Set up follow-up appointment(s), either in-person or via phone/video.</b> Do discuss any safety or privacy plan if needed.',
...

    {
      ...
      content: [
        '<b>Ectopic pregnancy (EP)</b> is rare. It occurs in 1 or 2 out of 100 pregnancies in the general population, and the rate is consistently lower among those seeking abortion. It is recommended that <b>patients undergo ultrasound if they have significant medical risk factors, signs or symptoms of EP[6]</b>.',
...

    {
      ...
      content: [
        ...
        'According to the <a class ="ex" href="https://www.jogc.com/article/S1701-2163(24)00260-3/abstract" target="_blank">SOGC’s Guideline on Prevention of RhD Alloimmunization</a> published in 2024, for non-sensitized Rh D-negative individuals who have experienced threatened, spontaneous or induced abortion after <b>12 weeks gestation</b>, administration of 300 μg of Rho(D) immune globulin is suggested.',
...

    {
      ...
      content: [
        ...
        '<b>Emotional support[6]:</b> Emotional response after MA often vary. Some people feel relieved and positive and some have feelings of grief, sadness, or guilt while others have mixed feelings. These emotions are normal, and they may or may not be related to socioeconomic circumstances, the lack of social support, moral discomfort, and family conflict.',
...

    {
      ...
      content: [
        ...
        '<b>Clinical history[6]:</b> The assessment of successful expulsion based on medical history is highly predictive of complete abortion (sensitivity 99.1%, specificity 45.5%). No bleeding or minimal bleeding after MISO, and continuing pregnancy symptoms are suggestive of an ongoing pregnancy.',
        '<h2>Urine bhCG[7]:</h2>',
        '<h2>Serum bhCG[3]:</h2>',
...

    {
      ...
      content: [
        '<b>Ongoing pregnancy[6]:</b> Ongoing pregnancy after medication abortion is uncommon and can be treated with another dose of MISO or with procedural abortion. Procedural abortion is recommended if cardiac activity is present 14 to 21 days after taking MISO.',
        '<b>Retained products of conception[6]:</b> In the absence of ongoing pregnancy, retained products of conception can be managed by asking patients to wait for bleeding and cramping, offering them another dose of MISO, or providing them with or referring them for procedural abortion. Urgent procedural abortion is indicated in cases of heavy uncontrolled bleeding or retained products of conception associated with endometritis.',
        ...
        '<b>Post-abortion infections[6]:</b> Treatment should be individualized and usually consists of broad-spectrum therapy. In mild cases, oral antibiotics can be used, but if infection is severe, patients should be hospitalized for treatment. Once patients start antibiotics, procedural abortion may be necessary to remove significant retained products of contraception.',
...

    {
      ...
      content: [
        ...
        '<ul><li>Sex and U’s <b><a class="ex" href="https://www.itsaplan.ca/"target="_blank" >It’s a plan</a></b>, an online health information tool to determine the right contraception method.',
        '<li><b><a class="ex" href="https://www.actioncanadashr.org/sexual-health-hub/birth-control" target="_blank">Action Canada’s Sexual Health Hub</a></b> on Birth Control, a website that contains information on birth control in Canada.</ul>',
...

    {
      ...
      content: [
        ...
        '<ol><li><b>Review pregnancy options counselling.</b>',
        '<li><b>Establish pregnancy and gestational age.</b>',
        '<li><b>Exclude </b><a class="in" href="https://caps.sogc.org/prescribing/?heading=About-Mifegymiso&subheading=Indication-&-Contraindications#3" target="_blank" >contraindications</a>.',
        '<li><b>Assess the need for an ultrasound to determine gestational age and the location of pregnancy[5]:</b>',
        ...
        '<li><b>Assess the need for blood work to measure hemoglobin[7]:</b>',
        ...
        '<li><b>Assess the need for blood work to determine </b><a class="in" href="https://caps.sogc.org/prescribing/?heading=Pre-abortion-Medical-Evaluation&subheading=Rhesus-Screening#5" target="_blank" >Rhesus status (Rh)</a>[7]:',
        '<ul><li>As explained elsewhere, guidelines on Rh status have been updated and vary between organizations.',
        '<li>According to the <b><a class="ex" href="https://www.jogc.com/article/S1701-2163(24)00260-3/abstract" >SOGC’s Guideline on Prevention of RhD Alloimmunization</a></b> published in 2024, for non-sensitized Rh D-negative individuals who have experienced threatened, spontaneous or induced abortion after 12 weeks gestation, administration of 300 μg of Rho(D) immune globulin is suggested.',
        ...
        '<li><b>Assess the need for</b> <a class="in" href="https://caps.sogc.org/prescribing/?heading=Pre-abortion-Medical-Evaluation&subheading=Anemia,-STIs-&-Others" target="_blank">STI testing</a>[7]:',
...

    {
      ...
      title: 'Follow-up',
      content: [
        'The follow-up appointment should be scheduled <b>3 to 7 days after taking</b> misoprostol (MISO), and more than one follow-up appointment may be needed. The SOGC’s protocol on the provision of medication abortion by telemedicine advises 7 days[7], but some prescribers schedule the follow-up appointment as early as 3 days after MISO administration to avoid loss-of-contact and assess serum bhCG level. The actual practices depend on prescribers’ judgment and experiences.',
        'During the virtual follow-up, prescribers should[7]:',
        '<ol>',
        '<li><b>Review abortion experience and progress</b> with patients, including dates of taking medication, side effects, bleeding pattern, pain, occurrence of expulsion, and any current pregnancy symptoms.',
        ...
        '<li></b>If history suggests failed abortion or ongoing pregnancy:</b> obtain ultrasound and consider an additional dose of MISO or procedural abortion.',
        '<li><b>If history suggests successful abortion, no warning signs, and no current symptoms of pregnancy, normal bleeding and pain:</b> arrange the blood test to confirm serum bhCG level if the appointment is in-person or instruct the patient to perform qualitative urine pregnancy test.',
        '<b>Serum bhCG[4]</b>: If the serum bhCG level drops by >50% at Day 3 after MISO or 80% at Day 7-14 after MIFE / MISO administration, the successful completion of abortion is confirmed and no further appointment is needed. Ultrasound should be ordered if 14 days have passed and a drop by 80% has not been reached.',
        '<b>Urine bhCG[7]:</b>',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Mifegymiso is approved by Health Canada for gestational age up to 63 days, but has been shown by SOGC to be <b>safe and effective</b> for up to 70 days.',
        '<li>It is provided <b>free-of-charge</b> to all patients with provincial health insurance and several categories of <a class="in" href="https://caps.sogc.org/prescribing/?heading=Regulations,-Insurance-&-Inclusivity-Toolkits&subheading=Federal-Insurance-Schemes#1" target="_blank">federal health insurances</a>.',
        ...
        '<li>It can be prescribed through <b>in-person visits</b> or <a class="in" href="https://caps.sogc.org/prescribing/?heading=Virtual-&-Hybrid-Care" target="_blank">virtual consultations</a>, or a combination of the two.',
        '</ul>',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Do have <b>accessible bathrooms for multiple genders</b> by removing “Male” and “Female” signs from washrooms, or replacing them with an “All Gender Bathroom” sign.',
        '<li>Do display <b>2SLGBTQIA+ inclusive posters, pamphlets, and other materials</b> to let your patients know that they are welcome.',
        '<li>Do use <b>inclusive clinical forms</b> (e.g., intake forms) that are inclusive of all sexual orientations and gender identities. Consider whether the questions you are asking are necessary to ask for clinical purposes, or if they are asked out of curiosity only.',
        '<li>Do <b>ask which pronouns patients prefer</b> and use them consistently throughout their care.',
        '<li>Do ask patients and observe what <b>words they use to refer to their body parts</b>, and mirror their language.',
        '<li>Do respect trans <b>patients’ rights to educate</b> on trans issues or speak on behalf of the needs of trans patients.',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Offer <b>translation services</b>, and where possible, translated resources.',
        '<li>Connect with, and advocate for the involvement of, Indigenous patient navigators in your area.',
        '<li>When hearing about difficult or violent experiences from patients, affirm their experiences and stories. <b>Avoid shaming them for the feelings they have, or the ways they use to cope.</b>',
        '<li><b>Create and maintain a list of available resources and cultural supports</b> within your region, including social services.',
        '<li><b>Support your patients to participate in the creation of their treatment plans</b>, including the incorporation of traditional and cultural resources and methods.',
        '<li>Avoid saying “Canada’s Indigenous Peoples” or “Our Indigenous Peoples” – <b>The Indigenous Peoples are not owned by Canada or by any individual.</b>',
        '<li>Avoid saying “The Indigenous culture” – <b>this phrase does not recognize that there are hundreds of Indigenous communities, nations, languages and cultures existing in Canada.</b> Instead of singular, try using plural forms “Indigenous cultures” or even better, being specific about the nation to avoid pan-Indigenizing.',
        '</ul>',
      ],
    },
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b>Buccal</b>: time to first uterine contraction is 67 minutes, sustained for about 90 minutes and begins to decline at 5 hours after administration. The uterine response appears similar to that of vaginal administration, with less inter-individual variability.',
        '<li><b>Vaginal</b>: time to first uterine contraction is 82 minutes for dry tablets and 98 minutes for moistened tablets, sustained activity is attained at 106 minutes and 128 minutes, respectively, and uterine activity begins to decline at five hours after administration.',
        '<li><b>Sublingual</b>: tablets are absorbed through the mucosa within 20 minutes and MISO reaches peak serum concentration at 30 minutes. First-pass metabolism is avoided.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b>Gestational age</b> is determined using medical history, urine or serum βhCG test, or ultrasound. Ultrasound is not required to determine gestational age, unless people seeking abortion are uncertain of their last menstrual period[6,7].',
        '<li><b>Ectopic pregnancy</b> is ruled out using medical history to screen for risk factors and symptoms. Ultrasound is recommended if there are significant risk factors or symptoms suggestive of ectopic pregnancy[6,7].',
        '<li>Guideline on <b>Rhesus testing and administration</b> varies:',
        '<ul>',
        ...
        '</ul>',
        '<li><b>Complete blood count</b> to measure hemoglobin level is indicated if there is an increased risk of anemia; otherwise, it is unnecessary[7].',
        '<li>Routine <b>prophylactic antibiotics</b> are not required; screen-and-treat is the preferred management strategy and it is performed by the prescriber[6].',
        '</ul>',
      ],
    },
...

    {
      ...
      content: [
        ...
        'People taking medication abortion can <b>return to fertility rapidly</b> and hence should consider taking contraceptives.',
      ],
      images: [
        {
          title: 'Post-abortion Contraception',
    ...
    },
    {
      ...
      title: 'Medication',
      content: [
        '<b>Q: When was the mifepristone (RU-486) / misoprostol drug regimen first approved in Canada? In other countries?</b>',
        ...
        '<b>Q: What is the approved MIFE200 / MISO800 dosing regimen in Canada?</b>',
        ...
        '<b>Q: If the person who consults me for a medication abortion has an absolute contraindication to using MIFE200 / MISO800, what are the other options for abortion?</b>',
    ...
    },
    {
      ...
      content: [
        '<b>Q: What topics should I cover in the initial pregnancy options counseling session with the person seeking abortion?</b>',
        ...
        '<b>Q: How can I support the patient emotionally after the abortion?</b>',
    ...
    },
    {
      ...
      content: [
        '<b>Q: What will a person experience during the medication abortion with mifegymiso?</b>',
        ...
        '<b>Q: What factors influence the pain experienced by the person during medication abortion?</b>',
        ...
        '<b>Q: What symptom management can I offer to the person who is undergoing a MIFE200 / MISO800 medication abortion?</b>',
        ...
        '<b>Q: How can I define “too much bleeding” to a person undergoing a medical abortion?</b>',
        ...
        '<b>Q: Should a pharmacist obtain a new prescription from the physician or nurse practitioner prescribing Mifegymiso if vomiting occurs within 30 minutes following a MISO dose?</b>',
        ...
        '</ul>',
        '<b>Q: How can I tell if my patient is experiencing toxic shock due to a clostridial infection?</b>',
    ...
    },
    {
      ...
      title: 'Breastfeeding',
      content: [
        '<b>Q: Can I give Mifegymiso to a woman who is breastfeeding?</b>',
        ...
        '<b><i>Mifepristone Summary of Use during Lactation (NLM):</i></b>',
    ...
    },
    {
      ...
      content: [
        '<b>Q: Can Mifegymiso be used for the termination of multiple gestation (i.e. twin pregnancy)? What’s the evidence / success?</b>',
    ...
    },
    {
      ...
      title: 'Methadone',
      content: [
        '<b>Q: Is there an interaction between methadone and mifepristone?</b>',
        '<i>A: Bottom Line:</i>',
  ...
  fr: [
    ...
    },
    {
      ...
      content: [
        '<h2>Efficacité:</h2>',
        '<ul>',
        '<li>Le MIFÉ / MISO est <b>très efficace</b>. Le risque de poursuite de la grossesse est de 0,9 % pour les grossesses jusqu’à 49 jours d’âge gestationnel et de 3,1 % pour les grossesses jusqu’à 70 jours d’âge gestationnel[10].',
        '<li>Selon le protocole de la SOGC pour l’avortement médicamenteux par télémédecine, la personne doit prendre une première dose de MISO par voie buccale ou vaginale <b>24 à 48 heures</b> après avoir pris de la MIFÉ[7].',
        '<li>De plus, les personnes dont l’âge gestationnel est de 63 jours ou moins doivent prendre <b>la deuxième dose de</b> MISO si aucun saignement ne survient dans les 24 heures suivant la première dose de MISO ou selon les instructions du clinicien. Les personnes dont l’âge gestationnel est supérieur à 63 jours doivent prendre une deuxième dose de MISO 4 heures après la première dose[7].',
        '</ul>',
        '<h2>Effets secondaires et complications[10]:</h2>',
        '<ul>',
        '<li><b>Très fréquent (≥ 10 %):</b> nausées, vomissements, diarrhée, étourdissements, maux de tête, frissons/fièvre, faiblesse, fatigue, inconfort gastrique, douleurs abdominales, saignements vaginaux, microrragies, contractions ou crampes utérines.',
        '<li><b>Fréquent (1-10 %):</b> évanouissement, crampes gastro-intestinales légères ou modérées, saignements post-avortement prolongés, endométrite, sensibilité des seins, saignements abondants (pouvant ou non nécessiter un avortement par instruments).',
        '<li><b>Peu fréquent (0,1-1 %):</b> arythmie, choc hémorragique, salpingite, saignements abondants nécessitant des liquides IV ou une transfusion sanguine, infection, bouffées de chaleur, hypotension, bronchospasme, éruption cutanée / prurit.',
        '</ul>',
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b>Examiner les options de grossesse</b> lorsque cela est indiqué: avortement, devenir parent ou confier l’enfant en adoption.',
        ...
        '<li><b>Utilisez un langage sans jugement et inclusif</b>.',
        '</ul>',
        ...
        '<li><b>Discuter de l’éligibilité de la personne à l’avortement par médicaments</b>, y compris l’âge gestationnel et les antécédents médicaux.',
        '<li><b>Discuter de l’accès de la personne aux pharmacies, au téléphone, aux transports, aux soins d’urgence, ainsi qu’aux installations de laboratoires et d’imagerie</b> si nécessaire.',
        ...
        '<li>Confirmer que la personne comprend que <b>l’avortement par médicaments est irréversible</b> et qu’elle devra prendre une dose supplémentaire du deuxième médicament ou procéder à un avortement par instruments en cas d’échec (poursuite de la grossesse).',
    ...
    },
    {
      ...
      content: [
        'After the patient and the health provider determine that medication abortion (MA) is the right option, the health provider should[2,6,7,10]:',
        '<ol>',
        '<li><b>Obtenir un consentement éclairé écrit ou verbal</b> (voir exemples sur <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C78.pdf"  target="_blank">la plateforme CAPS-CPCA et le Bay Center for Birth Control</a>) et le documenter dans le dossier de la personne.',
        '<li><b>Prescrire:</b>',
        '<ul>',
        ...
        '</ul>',
        '<li>Discuter des options de contraception après un avortement. <b>Souligner le fait que les personnes peuvent rapidement retrouver leur fertilité après un avortement</b>.',
        '<li><b>Planifier des rendez-vous de suivi, soit en personne, soit par téléphone/vidéo</b>. Discuter d’un plan de sécurité ou de confidentialité si nécessaire.',
    ...
    },
    {
      ...
      content: [
        ...
        '<b>Si le taux de βhCG sérique est > 2000 UI/L et qu’aucun sac gestationnel intra-utérin n’est visualisé à l’échographie[6]:</b>',
        '<li>Une évaluation plus approfondie est nécessaire.',
        '<b>En l’absence de facteurs de risque de GE, si le taux de βhCG est ≤ 2 000 UI/L ou si un sac gestationnel probable est présent sans vésicule vitelline ni pôle fœtal[6]:</b>',
        '<ul>',
    ...
    },
    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b><a class="ex" href="https://exhaleprovoice.org/" target="_blank" >Exhale</a></b>, une ligne téléphonique qui fournit un soutien émotionnel, des ressources et des informations après un avortement.',
        '<li><b><a class="ex" href="https://www.all-options.org/" target="_blank" >All-Options</a></b>, une ligne de discussion pour discuter des expériences passées ou actuelles en matière d’avortement, d’adoption et de parentalité pour les personnes au Canada et aux États-Unis (1-888-493-0092).',
        '</ul>',
      ],
      images: [
        {
...

    {
      ...
      content: [
        '<b>Poursuite de la grossesse[6]</b>: La poursuite de la grossesse après un avortement par médicaments (AM) est rare et peut être traitée par une dose répétée de MISO ou par un avortement par instruments. Un avortement par instruments est recommandé si une activité cardiaque est présente de 14 à 21 jours après la prise du MISO.',
        '<b>Retention des produits de conception[6]</b>: En l’absence d’une grossesse évolutive, la rétention des produits de conception peut être gérée de façon conservatrice (attendre les saignements et les crampes spontanées), par une dose additionnelle de MISO, ou via une aspiration uterine. L’avortement par instruments d’urgence est indiqué en cas de saignements abondants incontrôlés ou d’une infection (endométrite).',
        ...
        '</ul>',
        '<b>Syndrome de choc toxique[6]</b>: Le syndrome de choc toxique est associé à Clostridium et au streptocoque du groupe A. La majorité de ces infections sont fulminantes et évoluent rapidement vers le choc. L’antibiothérapie standard n’est pas suffisante. Le traitement consiste en des soins de soutien et un traitement antibiotique empirique couvrant les espèces de Clostridium et d’autres organismes connus pour provoquer un choc toxique, ainsi qu’un débridement chirurgical, y compris une éventuelle hystérectomie.',
...

    {
      ...
      content: [
        ...
        '<ol>',
        '<li><b>Revoir le counseling sur les options de grossesse.</b>',
        '<li><b>Confirmer la grossesse et établir l’âge gestationnel.</b>',
        '<ul>',
        ...
        '</ul>',
        '<li><b>Exclure les contre-indications.</b>',
        '<li><b>Évaluer la nécessité d’une échographie pour déterminer l’âge gestationnel et la localisation de la grossesse[5]</b>:',
        '<ul>',
        ...
        '</ul>',
        '<li><b>Déterminer la nécessité d’analyses sanguines pour mesurer l’hémoglobine[7]</b>:',
        '<ul>',
        ...
        '</ul>',
        '<li><b>Évaluer la nécessité d’analyses sanguines pour déterminer le facteur Rhésus (Rh)[7]</b>:',
        '<ul>',
        ...
        '</ul>',
        '<b>Évaluer la nécessité de tester les ITSS[7]:</b>',
        '<ul>',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b>Questionner le déroulement de l’avortement</b y compris les dates de prise des médicaments, les effets secondaires, la description des saignements, la douleur, le moment d’expulsion des produits de conception, et tout symptôme indiquant une grossesse évolutive.',
        ...
        '<li><b>Si l’histoire suggère un échec d’avortement ou une grossesse évolutive</b> envisager une dose supplémentaire de MISO ou un avortement par instruments: obtenir une échographie',
        '<li><b>Si l’histoire suggère un avortement réussi sans signe d’alerte ni symptôme de grossesse évolutive ainsi que des saignements et des douleurs normaux:</b>',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Rendre des <b>toilettes non genrées</b> en supprimant les panneaux “Hommes” et “Femmes” des toilettes, ou en les remplaçant par un panneau “Toilettes tous genres”.',
        '<li>Publier <b>des affiches, des dépliants et d’autres documents 2ELGBTQIA+ inclusifs</b> pour faire savoir à tous qu’ils sont les bienvenus.',
        '<li>Utiliser des <b>formulaires cliniques inclusifs</b> (par exemple, des formulaires d’admission) qui tiennent compte de toutes les orientations sexuelles et identités de genre. Déterminer si les questions posées sont nécessaires à des fins cliniques ou si elles sont posées par curiosité.',
        '<li>Demander <b>quels pronoms les personnes préfèrent>b> et utiliser-les de manière cohérente tout au long de leurs soins.',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Proposer des <b>services de traduction</b> et, si possible, des ressources traduites.',
        ...
        '<li>Lorsqu’on entend parler d’expériences difficiles ou violentes de la part des personnes, affirmer leurs expériences et leur vécu. <b>Éviter de les stigmatiser pour leurs sentiments ou la façon dont ils gèrent leurs émotions.</b>',
        '<li><b>Créer et maintenir une liste des ressources disponibles et de soutien culturel</b> dans votre région, y compris les services sociaux.',
        '<li><b>Les soutenir dans la création de leur propre plan de traitement</b>, y compris l’intégration de ressources culturellement sécurisantes et méthodes de guérison traditionnelles.',
        '<li>Éviter de dire “Les peuples autochtones du Canada” ou “Nos peuples autochtones.” – <b>Les peuples autochtones n’appartiennent pas au Canada ni à aucun individu.</b>',
        '<li>Éviter de dire “La culture autochtone.” – <b>Cette phrase ne reconnaît pas qu’il existe des centaines de communautés, nations, langues et cultures autochtones au Canada. Au lieu du singulier, essayer d’utiliser des formes plurielles comme “Les cultures autochtones” ou mieux encore, être précis sur la nation pour éviter la pan-indigénisation.</b>',
        '</ul>',
      ],
    },
...

    {
      ...
      content: [
        ...
        '</ul>',
        '<b>S’assurer que les personnes comprennent comment administrer MIFÉ / MISO, comment gérer les effets secondaires, et savent quand et comment demander des soins</b> (voir ci-dessous).</b>',
      ],
    },
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b>Buccale</b>: le délai jusqu’à la première contraction utérine est de 67 minutes, soutenu pendant environ 90 minutes et commence à diminuer 5 heures suivant l’administration. La réponse utérine semble similaire à celle de l’administration vaginale, avec moins de variabilité interindividuelle.',
        ...
        '<li><b>Sublinguale</b>: les comprimés sont absorbés par la muqueuse en 20 minutes et le MISO atteint sa concentration sérique maximale à 30 minutes. Le métabolisme de premier passage est évité.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><b>L’âge gestationnel</b> est déterminé à l’aide des antécédents médicaux, d’un test urinaire ou βhCG sérique, ou d’une échographie. L’échographie n’est pas nécessaire pour déterminer l’âge gestationnel, sauf en cas d’incertiture de la date des dernières menstruations (DDM).[6,7].',
        '<li><b>Une grossesse ectopique</b> est exclue en utilisant les antécédents médicaux pour dépister les facteurs de risque et les symptômes. L’échographie est recommandée s’il existe des facteurs de risque importants ou des symptômes évocateurs d’une grossesse ectopique.[6,7].',
        '<li>Les ligne directrices pour <b>le test et l’administration du facteur Rhésus (Rh)</b> varient:',
        '<ul>',
        ...
        '</ul>',
        '<li><b>Une formule sanguine complète</b> pour mesurer le taux d’hémoglobine est indiquée en cas de risque accru d’anémie ; sinon c’est inutile[7].',
        '<li>Une <b>antibioprophylaxie</b> de routine n’est pas nécessaire; le dépistage et le traitement au besoin constituent la stratégie de prise en charge privilégiée et est effectué par le prescripteur[6].',
        '</ul>',
      ],
    },
    ...
    },
    {
      ...
      title: 'Médicaments',
      content: [
        '<b>Q: Quand le régime mifépristone (RU-486) / misoprostol a-t-il été approuvé pour la première fois au Canada? Dans d’autres pays?</b>',
        ...
        '<b>Q: Quel est le schéma posologique approuvé pour MIFE 200 / MISO 800 au Canada?</b>',
        ...
        '<b>Q: Si la personne souhaitant un avortement par médicaments a une contre-indication absolue à l’utilisation de MIFE200 / MISO800, quelles sont les autres options d’avortement?</b>',
        ...
        '<b>Q: L’avortement par médicaments affecte-t-il la fertilité de la personne ou l’issue des grossesses futures?</b>',
    ...
    },
    {
      ...
      title: 'Counseling',
      content: [
        '<b>Q: Quels sujets devrais-je aborder lors de la séance initiale de counseling sur les options de grossesse avec la personne souhaitant avorter?</b>',
        ...
        '<b>Q: Comment puis-je soutenir émotionnellement la personne après l’avortement?</b>',
    ...
    },
    {
      ...
      content: [
        '<b>Q: Que ressentira une personne lors d’un avortement par médicaments avec Mifé-Miso?</b>',
        ...
        '<b>Q: Quels facteurs influencent la douleur qu’une personne ressent lors d’un avortement par médicaments?</b>',
        ...
        '<b>Q: Quels conseils pour la gestion des symptômes puis-je proposer à la personne qui subit un avortement par médicaments MIFE200 / MISO800?</b>',
        ...
        '<b>Q: Comment définit-on « trop de saignements » pour une personne qui a recours à un avortement par médicaments?</b>',
        ...
        '<b>Q: Un pharmacien devrait-il obtenir une nouvelle prescription du médecin ou de l’infirmière praticienne spécialisée qui a prescrit le Mifé-Miso, si des vomissements surviennent dans les 30 minutes suivant la prise de la dose de MISO?</b>',
        ...
        '</ul>',
        '<b>Q: Comment savoir si une personne subit un choc toxique dû à une infection à Clostridium?</b>',
    ...
    },
    {
      ...
      title: 'Allaitement',
      content: [
        '<b>Q: Le Mifé-Miso peut-il être administré à une femme qui allaite?</b>',
    ...
    },
    {
      ...
      content: [
        '<b>Q: Mifé-Miso peut-il être utilisé pour interrompre une grossesse multiple (c’est-à-dire une grossesse gémellaire)? Quelles sont les preuves / le taux de réussite?</b>',
    ...
    },
    {
      ...
      title: 'Methadone',
      content: [
        '<b>Q: Y a-t-il une interaction entre la méthadone et la mifépristone?</b>',
        '<i>R: Conclusion:</i>',
