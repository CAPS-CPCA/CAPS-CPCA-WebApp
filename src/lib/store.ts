...
const modules: { [key: string]: Modules } = {
  en: [
    {
      id: 'M1',
  ...
  fr: [
    {
      ...
      content: [
        ...
        'Cliquez ici pour télécharger la <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C17-2.pdf"  target="_blank">monographie du produit.</a>',
      ],
      images: [
        {
          title: 'Mifegymiso',
...

    {
      ...
      content: [
        '<h2>Efficacité:</h2>',
        '<ul>',
        '<li>Le MIFÉ / MISO est <strong>très efficace</strong>. Le risque de poursuite de la grossesse est de 0,9 % pour les grossesses jusqu’à 49 jours d’âge gestationnel et de 3,1 % pour les grossesses jusqu’à 70 jours d’âge gestationnel[10].',
        '<li>Selon le protocole de la SOGC pour l’avortement médicamenteux par télémédecine, la personne doit prendre une première dose de MISO par voie buccale ou vaginale <strong>24 à 48 heures</strong> après avoir pris de la MIFÉ[7].',
        '<li>De plus, les personnes dont l’âge gestationnel est de 63 jours ou moins doivent prendre <strong>la deuxième dose de</strong> MISO si aucun saignement ne survient dans les 24 heures suivant la première dose de MISO ou selon les instructions du clinicien. Les personnes dont l’âge gestationnel est supérieur à 63 jours doivent prendre une deuxième dose de MISO 4 heures après la première dose[7].',
        '</ul>',
        '<h2>Effets secondaires et complications[10]:</h2>',
        '<ul>',
        '<li><strong>Très fréquent (≥ 10 %):</strong> nausées, vomissements, diarrhée, étourdissements, maux de tête, frissons/fièvre, faiblesse, fatigue, inconfort gastrique, douleurs abdominales, saignements vaginaux, microrragies, contractions ou crampes utérines.',
        '<li><strong>Fréquent (1-10 %):</strong> évanouissement, crampes gastro-intestinales légères ou modérées, saignements post-avortement prolongés, endométrite, sensibilité des seins, saignements abondants (pouvant ou non nécessiter un avortement par instruments).',
        '<li><strong>Peu fréquent (0,1-1 %):</strong> arythmie, choc hémorragique, salpingite, saignements abondants nécessitant des liquides IV ou une transfusion sanguine, infection, bouffées de chaleur, hypotension, bronchospasme, éruption cutanée / prurit.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<h2>Contre-indications[6]:</h2>',
        '<ul>',
        '<li>Grossesse ectopique',
        '<li>Insuffisance surrénalienne chronique',
        '<li>Porphyrie héréditaire',
        '<li>Asthme incontrôlé',
        '<li>Trouble hémorragique ou traitement anticoagulant concomitant',
        '<li>Anémie (taux d’Hb < 95 g/L)',
        '<li>Corticothérapie systémique au long cours',
        '<li>Allergies ou hypersensibilité aux ingrédients du produit',
        '<li>DIU in situ (n’est plus une contre-indication une fois retiré)',
        '<li>Maladies systémiques graves telles que maladies du foie, maladies cardiaques, insuffisance rénale et troubles épileptiques (ces maladies doivent être évaluées individuellement)',
        '<li>Âge gestationnel incertain',
        '<li>Incertitude décisionnelle',
        '</ul>',
        '<h2>Allaitement[6]:</h2>',
        ...
        '<h2>Âge gestationnel > 63 jours</h2>',
        'La Société des Obstétriciens et Gynécologues du Canada et la <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C6.pdf"  target="_blank">National Abortion Federation (NAF)</a> approuvent toutes deux l’avortement par médicaments (AM) avec MIFÉ / MISO jusqu’à 70 jours après la LMP. Elles recommandent également une deuxième dose de MISO 800mcg quatre heures après la première dose de MISO 800mcg pour augmenter l’efficacité de l’AM.[5,13].',
        ...
        '<h2>Personnes âgées de 15 à 18 ans</h2>',
...

    {
      ...
      content: [
        ...
        '<h2>Les points clés du counseling comprennent[4,6]:</h2>',
        '<ul>',
        '<li><strong>Examiner les options de grossesse</strong> lorsque cela est indiqué: avortement, devenir parent ou confier l’enfant en adoption.',
        '<li>Adapter le counseling aux besoins de la personne (par exemple contrer la stigmatisation de l’avortement et/ou fournir un soutien émotionnel).',
        '<li>Communiquer les risques liés à la progression de la grossesse sans exercer de pression temporelle à la personne.',
        '<li><strong>Utilisez un langage sans jugement et inclusif</strong>.',
        '</ul>',
        '(Si le choix est l’avortement:)',
        '<ul>',
        '<li>Examiner les <a class="in" href="https://caps.sogc.org/prescribing-fr/#1"  target="_blank">options d’avortement</a>, y compris les risques, l’efficacité, le processus et la durée du traitement par médicaments par rapport à l’avortement par instruments.',
        '<li><strong>Discuter de l’éligibilité de la personne à l’avortement par médicaments</strong>, y compris l’âge gestationnel et les antécédents médicaux.',
        '<li><strong>Discuter de l’accès de la personne aux pharmacies, au téléphone, aux transports, aux soins d’urgence, ainsi qu’aux installations de laboratoires et d’imagerie</strong> si nécessaire.',
        '<li>Discuter des <a class="in" href="https://caps.sogc.org/prescribing-fr/#1"  target="_blank">préférences et des circonstances de la personne</a>, comme par exemple un endroit sécuritaire à leur domicile pour réaliser l’avortement par médicaments.',
...

    {
      ...
      content: [
        ...
        '<li>Manquent de transport pour se rendre à la clinique pour un avortement par instruments (mais ont néanmoins accès aux services d’urgence en cas de complications).',
        '</ul>',
        ...
        '<li>Sont confortables avec une anesthésie locale ou générale pour gérer la douleur.',
...

    {
      ...
      content: [
        'After the patient and the health provider determine that medication abortion (MA) is the right option, the health provider should[2,6,7,10]:',
        '<ol>',
        '<li><strong>Obtenir un consentement éclairé écrit ou verbal</strong> (voir exemples sur <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C78.pdf"  target="_blank">la plateforme CAPS-CPCA et le Bay Center for Birth Control</a>) et le documenter dans le dossier de la personne.',
        '<li><strong>Prescrire:</strong>',
        '<ul>',
        '<li>Mifépristone 200 mg (MIFÉ) par voie orale et misoprostol 800 mcg (MISO) par voie buccale ou vaginale (cette combinaison est commercialisée et marquée sous le nom de Mifé-Miso).',
        '<li>Dose supplémentaire de MISO par voie buccale ou vaginale en cas d’avortement incomplet.',
        '<li>Analgésiques et antiémétiques selon le protocole du professionnel de la santé ou de l’établissement.',
        '<li>Antibioprophylaxie, si nécessaire, selon le protocole du professionnel de la santé ou de l’établissement.',
        '</ul>',
        '<li>Fournir des instructions sur <a class="in" href="https://caps.sogc.org/prescribing-fr/#1"  target="_blank">la façon de prendre le médicament</a>.',
        '<li>S’assurer que les personnes savent <a class="in" href="https://caps.sogc.org/prescribing-fr/#6"  target="_blank">comment gérer les effets secondaires</a> ainsi que quand et où consulter en cas de complications.',
        '<li>Envisager d’informer les personnes si la procédure d’AM implique des pratiques hors normes mais fondées sur des preuves.',
        '<ul>',
        '<li>Une grande partie des pratiques hors normes d’AM sont basées sur une faible quantité de ressources et nécessite un équilibre entre l’expérience des professionnels de la santé et la sécurité et les besoins des personnes qui ont recours à un avortement.',
        '<li>Il est recommandé d’informer les personnes des pratiques hors normes afin de comprendre les risques associés et savoir que ces pratiques hors normes peuvent varier en fonction de l’expérience et du niveau de confort des prescripteurs.',
        '</ul>',
        '<li>Discuter des options de contraception après un avortement. <strong>Souligner le fait que les personnes peuvent rapidement retrouver leur fertilité après un avortement</strong>.',
        '<li><strong>Planifier des rendez-vous de suivi, soit en personne, soit par téléphone/vidéo</strong>. Discuter d’un plan de sécurité ou de confidentialité si nécessaire.',
        '<li>Fournir aux personnes des manuels d’instructions (voir des exemples: <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C73.pdf"  target="_blank">SHORE center et Planned Parenthood Ottawa</a>) ainsi que les coordonnées des professionnels de santé et des services de santé d’urgence.',
        '<li>Prendre note des numéros de téléphone et des contacts d’urgence fournis en lien avec l’AM par la personne au cas où les professionnels de la santé ne seraient pas en mesure de la joindre directement. Se rappeler que les contacts d’urgence fournis par les personnes lors de leurs visites d’AM peuvent être différents des contacts d’urgence figurant dans le dossier. Veiller à ne contacter aucune autre personne sans son consentement explicite en lien avec l’AM.',
        '</ol>',
      ],
    },
...

    {
      ...
      content: [
        ...
        '<h2>Administration buccale de MISO[10]</h2>',
        '<ul>',
        '<li>Si des vomissements surviennent < 1 heure après la prise de MIFÉ ou lors de l’absorption buccale du MISO: Contacter un professionnel de la santé / pharmacien pour une évaluation.',
        '<li>Si des vomissements surviennent > 30 minutes après l’ingestion de fragments de MISO: Aucune action n’est requise.',
        '</ul>',
        '<h2></h2>',
        '<ul>',
        '<li>Si les comprimés tombent avant le début des saignements: Réinsérer le comprimé ou contacter un professionnel de la santé, s’il est impossible de le réinsérer.',
        '<li>Si les comprimés sortent lors des saignements: Aucune action n’est nécessaire ; dans la plupart des cas, une portion suffisante du médicament aura été absorbée.',
        '</ul>',
...

    {
      ...
      images: [{ title: '', src: images.SideEffectsManageFr, alt: '' }],
    },
...

    {
      ...
      content: [
        ...
        '<strong>Échographie</strong>: L’échographie est la mesure la plus précise de l’âge gestationnel (AG), mais ne constitue pas une exigence de routine, sauf si la personne n’est pas certaine de la date de ses dernières menstruations (DDM) (ou s’il existe des symptômes et des facteurs de risque de grossesse ectopique, comme expliqué, ci-dessous). Il est recommandé de choisir une clinique d’échographie dont le personnel offre des échographies sans jugement[6].',
        '<strong>Antécédents médicaux</strong>: Si la personne est certaine de la date de ses dernières menstruations (DDM) et si elle a eu des menstruations régulières sans utilisation récente de contraception hormonale, l’estimation de l’AG en fonction de sa date serait étroitement corrélée aux résultats de l’échographie[6].',
        '<strong>Examen gynécologique</strong>: Au premier trimestre, la détermination de l’AG par un examen bimanuel a été démontrée comme précise à deux semaines près de l’AG déterminée par échographie; cependant, la précision varie en fonction de l’expérience du technicien, de la quantité de tissu adipeux et de la présence de fibromes[6].',
        '<strong>Test βhCG</strong>: Le taux de βhCG augmente de manière linéaire au cours des 6 premières semaines de grossesse mais varie fortement par la suite et limite son utilité pour la datation[6].',
      ],
    },

    {
      ...
      content: [
        '<strong>La grossesse ectopique (GE) est rare. Elle survient dans 1 ou 2 grossesses sur 100 dans la population générale et le taux est systématiquement plus faible chez les personnes qui ont reours à l’avortement. Il est recommandé de prescrire une échographie aux personnes qui présentent des facteurs de risque, des signes ou des symptômes de GE.[6].</strong>',
        '<h2>Les principaux facteurs de risque, signes et symptômes de la GE comprennent[6]:</h2>',
        '<ul>',
        '<li>Grossesse ectopique (GE) antérieure.',
        '<li>Dispositif intra-utérin (DIU) en place.',
        '<li>Recours à des techniques de procréation assistée.',
        '<li>Chirurgie antérieure des trompes de Fallope telle que ligature des trompes.',
        '<li>Antécédents de salpingite ou de maladie inflammatoire pelvienne.',
        '<li>Symptômes de douleurs abdominales et de saignements vaginaux.',
        '</ul>',
        '<strong>Les grossesses multiples</strong> ne constituent pas une contre-indication à l’avortement par médicaments (AM), cependant la présence d’une grossesse multiple doit être communiquée à la personne si elle accepte d’obtenir des informations sur la grossesse[6].',
        '<strong>Les avortements manqués et incomplets</strong> doivent également être divulgués aux personnes si elles acceptent d’obtenir des informations échographiques et doivent être gérés soit par AM, soit par avortement par instruments[6].',
        'En cas de <strong>grossesse môlaire</strong>, une consultation, une analyse histologique des produits de conception et une surveillance des niveaux de βhCG sont essentiels avant l’avortement par instruments. L’AM n’est pas appropriée.[6].',
      ],
      images: [
        {
          title: 'Grossesse ectopique',
...

    {
      ...
      content: [
        ...
        '<strong>Si le taux de βhCG sérique est > 2000 UI/L et qu’aucun sac gestationnel intra-utérin n’est visualisé à l’échographie[6]:</strong>',
        '<li>Une évaluation plus approfondie est nécessaire.',
        '<strong>En l’absence de facteurs de risque de GE, si le taux de βhCG est ≤ 2 000 UI/L ou si un sac gestationnel probable est présent sans vésicule vitelline ni pôle fœtal[6]:</strong>',
        '<ul>',
        '<li>Les personnes peuvent recevoir un AM.',
        '<li>Lorsque ces personnes reçoivent un AM, elles doivent être informées des risques et des symptômes de GE, ainsi que la personne à contacter en cas d’urgence.',
        '<li>Un suivi de la βhCG dans les 7 jours est recommandée en cas de GLI. Une réduction de 50 % est attendue 3 jours après l’administration de MIFÉ (ou 24 à 48 heures après le MISO) ou de 80 % entre 7 et 14 jours après l’administration de MIFÉ / MISO; sinon, la possibilité d’une GE doit être éliminée.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        'Selon les lignes directrices de la SOGC sur la prévention de l’allo-immunisation RhD publiées en 2024, l’administration de 300 μg d’immunoglobuline Rho(D) est suggérée aux personnes Rh D-négatives non sensibilisées qui ont subi une menace d’avortement, un avortement spontané ou provoqué <strong>après 12 semaines de gestation</strong>.',
        'Auparavant, en 2022, la <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/SFP1.pdf"  target="_blank">Society of Family Planning</a> et <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/WHO1.pdf"  target="_blank">l’Organisation mondiale de la santé (OMS)</a> ont également recommandé de suspendre le test et l’administration du Rh avant 12 semaines de gestation pour les personnes subissant un avortement par médicaments (AM), un avortement spontané ou un avortement par aspiration utérine[8,20].',
      ],
    },
...

    {
      ...
      content: [
        ...
        '<strong>Histoire clinique[6]</strong>: L’évaluation de l’expulsion complète basée sur l’histoire médicale est fortement prédictive d’un avortement complet (sensibilité 99,1 %, spécificité 45,5 %). L’absence ou un saignement minime après la prise de MISO, ainsi que la persistance des symptômes de grossesse, suggèrent la poursuite de la grossesse.',
        '<strong>βhCG urinaire[7]:</strong>',
        '<strong>βhCG sérique[3]:</strong>',
        '<ul>',
        '<li>Une baisse d’au moins 50 % par rapport à la valeur initiale 3 jours après l’administration de MIFÉ (ou 24 et 48 heures après l’administration de MISO) est fortement indicative d’un avortement complet.',
        '<li>Une baisse de 80% entre 7 et 14 jours après l’administration de MIFÉ / MISO confirme un avortement complet.',
        "<li>Si la βhCG chute < 80 % entre le jour 7 et le jour 14, on peut prescrire une échographie ou répéter le test dans quelques jours. Une échographie doit être prescrite si 14 jours se sont écoulés et qu'une diminution de 80 % n'a pas été atteinte.",
        '</ul>',
        '<strong>Échographie[6]</strong>: L’échographie fournit une preuve définitive d’un AM complet, mais <strong>rien ne prouve que cette technique est supérieure aux autres méthodes</strong>. L’échographie est recommandée dans les cas où le résultat est incertain en fonction de l’histoire clinique ou en cas de symptômes tels qu’une douleur inattendue, des saignements abondants prolongés ou insuffisants.',
      ],
      images: [
        {
          title: 'Évaluation du succès de l’avortement ',
...

    {
      ...
      content: [
        '<strong>Poursuite de la grossesse[6]</strong>: La poursuite de la grossesse après un avortement par médicaments (AM) est rare et peut être traitée par une dose répétée de MISO ou par un avortement par instruments. Un avortement par instruments est recommandé si une activité cardiaque est présente de 14 à 21 jours après la prise du MISO.',
        '<strong>Retention des produits de conception[6]</strong>: En l’absence d’une grossesse évolutive, la rétention des produits de conception peut être gérée de façon conservatrice (attendre les saignements et les crampes spontanées), par une dose additionnelle de MISO, ou via une aspiration uterine. L’avortement par instruments d’urgence est indiqué en cas de saignements abondants incontrôlés ou d’une infection (endométrite).',
        ...
        '<strong>Infections post-avortement[6]</strong>: Le traitement devrait être individualisé et consiste généralement en une thérapie à large spectre. Dans les cas bénins, des antibiotiques oraux peuvent être utilisés, mais dans le cas d’infection grave, les personnes doivent être hospitalisées pour traitement intraveineux. Une fois que les personnes commencent à prendre des antibiotiques, un avortement par instruments peut être nécessaire pour éliminer les produits de conception retenus.',
        'Les symptômes des infections post-avortement comprennent',
        '<ul>',
        '<li>Douleurs abdominales ou pelviennes.',
        '<li>Pertes vaginales ou cervicales nauséabondes.',
        '<li>Saignements vaginaux prolongés ou microrragie.',
        '<li>Fièvre ou frissons (plus de 24 heures après le MISO).',
        '<li>Sensibilité utérine ou annexielle.',
        '<li>Leucocytose (élévation des globules blancs lors d’un examen de laboratoire).',
        '</ul>',
        '<strong>Syndrome de choc toxique[6]</strong>: Le syndrome de choc toxique est associé à Clostridium et au streptocoque du groupe A. La majorité de ces infections sont fulminantes et évoluent rapidement vers le choc. L’antibiothérapie standard n’est pas suffisante. Le traitement consiste en des soins de soutien et un traitement antibiotique empirique couvrant les espèces de Clostridium et d’autres organismes connus pour provoquer un choc toxique, ainsi qu’un débridement chirurgical, y compris une éventuelle hystérectomie.',
        'Les symptômes du syndrome de choc toxique comprennent',
        '<ul>',
        '<li>Malaise général avec nausées, vomissements et diarrhée.',
        '<li>Absence de fièvre (ou fièvre légère).',
        '<li>Douleurs abdominales minimes.',
        '<li>Faiblesse.',
        '<li>Symptômes pseudo-grippaux.',
        '<li>Tachycardie/hypotension.',
        '<li>Œdème.',
        '<li>Nombre élevé de globules blancs ou taux d’hémoglobine élevé (lors d’un examen en laboratoire).',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        'Les personnes recherchant <strong>plus d’informations sur les options de contraception</strong> peuvent être orientées vers :',
        '<ul>',
        '<li><a class="ex" href="https://www.itsaplan.ca/" target="_blank" >Ça se planifie</a> du site Le Sexe et moi, un outil d’information santé en ligne pour déterminer la méthode contraceptive appropriée.',
        '<li><a class="ex" href="https://www.actioncanadashr.org/sexual-health-hub/birth-control" target="_blank" >Contraception</a> d’Action Canada pour la santé et les droits sexuels, un site Web des informations sur la contraception au Canada.',
        '</ul>',
...

    {
      ...
      content: [
        '<strong>L’avortement par médicaments</strong> (AM) virtuel ou hybride, également appelé sans contact ou à faible contact, est une formule dans laquelle certains ou tous les rendez-vous sont effectués virtuellement par téléphone et/ou vidéo en réduisant ou en éliminant les analyses sanguines et les échographies. L’objectif est de réduire le risque pour les personnes de contracter des infections transmissibles (comme dans le cas du COVID-19) ou de réduire la distance à parcourir ou des délais avant d’avoir accès à l’avortement.',
        'Comme expliqué précédement, les soins virtuels et hybrides de l’AM peuvent être offerts dans un contexte de ressources limitées et nécessitent <strong>un équilibre entre l’expérience du prescripteur, la sécurité de la personne et ses besoins</strong>.',
        'Lorsqu’ils reçoivent des demandes d’avortement par médicaments virtuel ou hybride, les prescripteurs doivent[7]:',
        '<ol>',
        '<li>Confirmer l’identité de la personne et s’assurer qu’elle peut discuter de façon confidentielle et en sécurité.',
        '<li>Fournir des informations écrites sur l’avortement par médicaments et l’avortement par instruments avant la consultation.',
        '<li>Demander de passer un test de grossesse urinaire de pharmacie.',
        '<li>Planifier une première visite virtuelle par téléphone ou vidéo.',
        '</ol>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ol>',
        '<li><strong>Revoir le counseling sur les options de grossesse.</strong>',
        '<li><strong>Confirmer la grossesse et établir l’âge gestationnel.</strong>',
        '<ul>',
        '<li>Questionner la date des dernières menstruations (DDM) et la date du test de grossesse qualitatif positif.',
        '<li>Questionner les antécédents médicaux pertinents, y compris la contraception hormonale récente et les facteurs de risque et signes de grossesse ectopique.',
        '</ul>',
        '<li><strong>Exclure les contre-indications.</strong>',
        '<li><strong>Évaluer la nécessité d’une échographie pour déterminer l’âge gestationnel et la localisation de la grossesse[5]</strong>:',
        '<ul>',
        '<li>Selon le protocole de la SOGC sur l’avortement par médicaments via télémédecine, une échographie doit être obtenue si la date des dernières menstruations (DDM) est incertaine, si la DDM dépasse 70 jours et si les signes, symptômes ou facteurs de risque de grossesse ectopique (GE) sont présents.',
        '<li>L’avortement par médicaments réalisé en l’absence d’échographie est, par définition, une grossesse de localisation indéterminée (GLI) et doit être géré en conséquence. Bien que le risque de GE non détectée soit faible, une surveillance étroite est nécessaire pour s’assurer que l’avortement est complet.',
        '</ul>',
        '<li><strong>Déterminer la nécessité d’analyses sanguines pour mesurer l’hémoglobine[7]</strong>:',
        '<ul>',
        '<li>Selon Santé Canada, l’hémoglobine doit être supérieure à 9,5 g / dL avant de commencer l’AM.',
        '<li>Dépister les personnes à risque accru d’anémie via les antécédents médicaux détaillés.',
        '<li>Si l’on soupçonne un risque accru d’anémie, une formule sanguine complète est indiquée. Sinon, la mesure de l’hémoglobine n’est pas nécessaire.',
        '</ul>',
        '<li><strong>Évaluer la nécessité d’analyses sanguines pour déterminer le facteur Rhésus (Rh)[7]</strong>:',
        '<ul>',
        '<li>Comme expliqué précédement, les lignes directrices sur le facteur Rh ont été mises à jour et varient d’une organisation à l’autre.',
        '<li>La SOGC recommande la vérification et l’administration des immunoglobulines humaines anti-Rho pour les personnes dont la DDM dépasse 7 semaines. La SOGC conseille également de réserver l’administration lorsque la DDM dépassait 10 semaines pendant la pandémie de COVID-19.',
        '<li>La Fédération Nationale de l’Avortement (NAF), Society of Family Planning et l’Organisation mondiale de la santé (OMS) recommandent toutes le dépistage et l’administration des immunoglobulines humaines anti-Rho lorsque la DDM dépasse 12 semaines de gestation.',
        '</ul>',
        '<strong>Évaluer la nécessité de tester les ITSS[7]:</strong>',
        '<ul>',
        '<li>Proposer un dépistage de la chlamydia et de la gonorrhée lorsque la visite est en présentiel.',
        '<li>Sinon, évaluer le risque d’ITSS et envisager un test à distance si des facteurs de risque sont présents, et discuter de la nécessité potentielle d’un traitement antibiotique.',
        '</ul>',
        '</ol>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><strong>Questionner le déroulement de l’avortement</strong y compris les dates de prise des médicaments, les effets secondaires, la description des saignements, la douleur, le moment d’expulsion des produits de conception, et tout symptôme indiquant une grossesse évolutive.',
        '<li>Recommander une visite d’urgence en cas de signes de grossesse ectopique, d’infection pelvienne, de saignements abondants ou de douleur excessive.',
        '<li><strong>Si l’histoire suggère un échec d’avortement ou une grossesse évolutive</strong> envisager une dose supplémentaire de MISO ou un avortement par instruments: obtenir une échographie',
...

    {
      ...
      content: [
        ...
        '<strong>Remarque:</strong> Il n’y a aucune précision quant à savoir si les codes sont spécifiques aux spécialistes ou aux soins primaires dans le manuel de facturation du Manitoba. Ainsi, les fournisseurs devraient examiner les informations et appliquer les règles de leurs codes de facturation.',
      ],
    },
...

    {
      ...
      content: [
        ...
        '<strong>Examen d’ultrasonographie</strong>',
        '– 15315 Bureau – $38.15',
        '– 15316 Hôpital – $13.10',
...

    {
      ...
      content: [
        ...
        '<strong>Remarques:</strong> La Saskatchewan dispose d’un code désigné pour l’avortement en personne, mais pas d’un code virtuel, de sorte que les prestataires peuvent utiliser les codes génériques utilisés pour les applications régulières de télémédecine pour les soins primaires.',
      ],
    },
...

    {
      ...
      content: [
        ...
        '<li>',
        '</ul>',
        '<strong>Champ de pratique:</strong> Au moment de rédiger ces lignes, les médecins et les infirmières praticiennes spécialisées au Canada sont autorisées à prescrire le Mifé-Miso. Dans la plupart des cas, les pharmaciens sont responsables de la distribution des médicaments, mais certaines cliniques sont également autorisées à les fournir directement. À l’exception du Québec, les sages-femmes ne sont actuellement pas autorisées à prescrire du Mifé-Miso, mais elles peuvent fournir des soins d’avortement par médicaments en étroite collaboration avec des infirmières praticiennes spécialisées ou des médecins.',
        '<strong>Exigences spécifiques à la province:</strong> Les professionnels de la santé devraient vérifier les lignes directrices spécifiques et le champ d’exercise de leur province ou territoire. Par exemple, les exigences des provinces peuvent différer quant à savoir qui peut récupérer le médicament et si les pharmaciens doivent s’inscrire auprès de Celopharma, le fabricant du Mifé-Miso. <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/PG1.pdf"  target="_blank">Cliquez ici pour voir le résumé</a> de certains règlements spécifiques à la province pour la distribution du Mifé-Miso.',
        '<strong>Exigence de formation:</strong> Il n’est plus nécessaire de suivre une formation avant de prescrire ou de délivrer le Mifé-Miso, mais les professionnels de la santé peuvent trouver utiles les cours en ligne ci-dessous pour en savoir plus sur les soins d’avortement par médicaments.',
        '<ul>',
        '<li><a class="ex" href="https://sogc.org/en/rise/Events/event-display.aspx?EventKey=MATP2&WebsiteKey=4d1aa07b-5fc4-4673-9721-b91ff3c0be30" target="_blank" >Programme de formation sur l’avortement par médicaments</a>, de La SOGC, mis à jour en 2023 et offert au prix coûtant.',
        '<li><a class="ex" href="https://nafcanada.org/medication-abortion-virtual-course/" target="_blank" >Medication Abortion Training</a> for Primary Care Providers de la Fédération Nationale de l’Avortement, mis à jour en 2023 et offert au prix coûtant.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<h2>Réviser les protocoles:</h2>',
        '<ul>',
        '<li>Examiner les directives pour l’AM.',
        '<li>Préparer votre protocole et inviter l’équipe clinique à l’examiner et à fournir ses commentaires.',
        '<li>Déterminer si l’objectif d’offrir l’AM est d’ajouter ce service aux soins primaires déjà offerts ou s’il sera un service rendu à l’ensemble de la communauté.',
        '<li>Évaluer les protocoles associés, notamment la contraception, le dépistage et le traitement des ITSS, ainsi que d’autres services de santé sexuelle et reproductive, et les intégrer aux protocoles d’avortement, le cas échéant.',
        '</ul>',
        '<h2>Examiner les réglements et la rémunération:</h2>',
        '<ul>',
        '<li>Examiner les règlements provinciaux et territoriaux et le champ d’exercice des médecins et des infirmières praticiennes spécialisées, et évaluer la participation potentielle des sages-femmes autorisées à fournir un AM.',
        '<li>Pour les médecins, se familiariser avec les codes de facturation provinciaux pour la fourniture d’AM, y compris les codes pour tous les tests qui seraient effectués sur place.',
        '<li>Pour les infirmières praticiennes et les sages-femmes autorisées, examiner les processus de rémunération des associations professionnelles de votre juridiction.',
        '</ul>',
        '<h2>Répondre aux préoccupations liées à l’avortement au sein de votre équipe:</h2>',
        ...
        '<h2>Préparer des plans pour soutenir les populations mal desservies:</h2>',
        '<ul>',
        '<li>Évaluer la capacité de vos services à servir des populations mal desservies telles que les personnes non assurées, les personnes issues des communautés autochtones et les personnes identifiées comme 2ELGBTQIA+.',
        '<li>Envisager d’intégrer des soins tenant compte des traumatismes et des approaches de réduction des méfaits dans vos services.',
        '<li>Planifier des services d’AM en réduisant les barrières pour les populations mal desservies et examiner ces plans avec votre personnel.',
        '</ul>',
        '<h2>Examiner la capacité du personnel et de l’administration:</h2>',
        '<ul>',
        '<li>Examiner la capacité actuelle de la clinique à fournir un AM.',
        '<li>Déterminer la personne ou l’équipe clé qui sera principalement responsable des personnes ayant recours à l’AM.',
        '<li>Évaluer les meilleurs moments pour planifier des rendez-vous pour les personnes ayant recours à l’AM.',
        '<li>Consulter l’horaire de garde de votre clinique ou le service d’appel de votre hôpital local pour contacter les gynécologues-obstétriciens le cas échéant.',
        '<li>Pour le personnel clinique, organiser une formation approfondie sur le counseling, la fourniture de Mifé-Miso et la gestion des complications.',
        '<li>Pour le personnel de soutien, préparer des réponses téléphoniques et d’autres ressources pour leur faire référence et leur utilisation.',
        '</ul>',
        '<h2>Configurer votre établissement:</h2>',
        '<ul>',
        '<li>Évaluer la conception des salles d’attente, des zones de réception et des salles de counseling pour s’assurer qu’elles favorisent la confidentialité et l’intimité.',
        '<li>Examiner les ententes avec un laboratoire ou la capacité intra-établissement pour le test quantitatif de βhCG ainsi que des tests et de l’administration du facteur Rhésus.',
        '<li>Identifier les cliniques ou départements d’échographie dans votre communauté, si elles ne sont pas disponibles sur place.',
        '<li>Déterminer les fournitures ou équipements supplémentaires nécessaires.',
        '</ul>',
        '<h2>Identifier les cliniques de référence:</h2>',
        '<ul>',
        '<li>Trouver des cliniques d’avortement par instruments, si vous n’offrez pas ce service.',
        '<li>Identifier les cliniques d’avortement dans votre région qui peuvent accepter des références rapides, si votre emploi du temps ne peut pas accueillir les personnes en temps opportun, afin de garantir que ces personnes ne manquent pas la fenêtre pour un AM.',
        '<li>Trouver des pharmacies qui stockent régulièrement du Mifé-Miso et établir des relations avec des pharmacies locales qui pourraient stocker Mifé-Miso.',
        '</ul>',
        '<h2>Préparer les documents de communication:</h2>',
        '<ul>',
        '<li>Obtenir ou développer du matériel éducatif, des formulaires de consentement et d’autres formulaires de suivi.',
        '<li>Concevoir, imprimer et distribuer des affiches pour informer la population que vous prescrivez l’AM.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ol>',
        '<li>Tout d’abord, identifier les professionnels de la santé, les administrateurs et le personnel de soutien au sein de votre environnement, qui sont intéressés et engagés à fournir des services d’avortement.',
        '<li>Initier des discussions informelles avec vos collègues sur l’offre de services.',
        '<li>Envisager de mener une enquête anonyme auprès du personnel et des clients pour avoir une idée de leurs opinions et de leurs sentiments à l’égard de l’AM.',
        '<li>Envisager d’organiser un atelier pour clarifier les valeurs sur l’avortement, aborder l’opposition ou l’inconfort et déterminer les moyens de travailler ensemble pour fournir l’AM. Un atelier de clarification des valeurs liées à l’avortement peut être adapté en utilisant:',
        '<ul>',
        '<li><a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C35.pdf"  target="_blank">Values clarification toolkits</a> de la Fédération Nationale de l’Avortement.',
        '<li><a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C58-10.pdf"  target="_blank">Matériel sur le Values clarification workshop</a> du Reproductive Health Access Project.',
        '</ul>',
        '<li>Envisager de créer un comité de planification pour discuter des objectifs, des tâches, des échéanciers, des obstacles et des solutions.',
        '<li>Se renseigner sur d’autres centres de santé ou professionnels de la santé locaux qui ont intégré avec succès les services d’avortement dans leur pratique. Les inviter à des réunions, des ateliers et des séances de planification, ou solliciter leurs commentaires et conseils sur votre processus.',
        '<li>Élaborer un protocole pour les membres du personnel qui se sentent incapables de participer aux soins d’avortement.',
        '<li>Lors des entrevues d’embauche, discuter de l’avortement. Indiquer dans l’offre d’emploi que le candidat doit être ouvert à tous les aspects des soins reproductifs, y compris l’avortement.',
        '</ol>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Déterminant le coût du Mifé-Miso et des frais de consultation pour l’avortement par médicaments (AM) en tant que dépenses directes. Élaborer une liste de centres de santé communautaires et de cliniques de santé reproductive gérés par la ville où les personnes peuvent obtenir une prescription d’AM à faible coût ou sans frais.',
        '<li>Explorant les processus permettant de renoncer aux frais ou d’élaborer des accords de partage des coûts avec des organisations partenaires ou d’autres prestataires de services.',
        '<li>S’assurant que le personnel administratif et de soutien est au courant du plan.',
        '<li>Référant les personnes vers le fonds d’urgence de la Fédération Nationale de l’Avortement et d’Action Canada pour la santé et les droits sexuels:',
        '<ul>',
        '<li><a class="ex" href="https://nafcanada.org/about/contact-us/" target="_blank" >Patient Assistance Fund</a>: Pour parler avec quelqu’un du Dr. Morgentaler Patient Assistance Fund, veuillez appeler la ligne téléphonique sans frais NAF au 1-800-772-9100.',
        '<li><a class="ex" href="https://www.actioncanadashr.org/" target="_blank" >Norma Scarborough Fund</a> | Action Canada pour la santé et les droits sexuels (actioncanadashr.org)',
        '</ul>',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        'Ces suggestions ont été reproduites à partir de <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/PHSA1.pdf"  target="_blank">Gender Inclusive Language</a> de Trans Care BC, <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C27.pdf"  target="_blank">The Trans-inclusive Abortion Services</a> du SHORE Centre et la Fédération du Québec pour le planning des naissances, et du <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C104-1.pdf"  target="_blank">Handbook for Healthcare Providers Working with Clients from Diverse Communities</a> d’Action Canada pour la santé et les droits sexuels. Pour plus d’informations sur les mythes concernant la reproduction des personnes 2ELGBTQIA+, le vocabulaire et le glossaire à utiliser et à éviter, ainsi que des études de cas et des recommandations pour surmonter les obstacles, veuillez vous référer à ces manuels.',
        '<h2>À faire et à ne pas faire:</h2>',
        '<ul>',
        '<li>Rendre des <strong>toilettes non genrées</strong> en supprimant les panneaux “Hommes” et “Femmes” des toilettes, ou en les remplaçant par un panneau “Toilettes tous genres”.',
        '<li>Publier <strong>des affiches, des dépliants et d’autres documents 2ELGBTQIA+ inclusifs</strong> pour faire savoir à tous qu’ils sont les bienvenus.',
        '<li>Utiliser des <strong>formulaires cliniques inclusifs</strong> (par exemple, des formulaires d’admission) qui tiennent compte de toutes les orientations sexuelles et identités de genre. Déterminer si les questions posées sont nécessaires à des fins cliniques ou si elles sont posées par curiosité.',
        '<li>Demander <strong>quels pronoms les personnes préfèrent>strong> et utiliser-les de manière cohérente tout au long de leurs soins.',
        '<li>Interroger les personnes et observer les mots qu’ils utilisent pour parler de leurs parties du corps et utiliser leur langage.',
        '<li>Respecter le droit des personnes trans de fournir de l’information sur les problèmes ou besoins de la communauté trans ou de parler au nom de la communauté trans.',
        '<li>Chercher à éliminer les barrières pour les personnes 2ELGBTQIA+.',
        '<li>N’utiliser PAS d’étiquettes et de termes dérivés d’anciennes versions du DSM et de la CIM, tels que transsexuel, transsexualité et trouble de l’identité de genre.',
        '<li>N’utiliser PAS de termes et expressions péjoratives même si la personne le fait.',
        '</ul>',
        '<h2>Gender-inclusive language:</h2>',
        '<table>',
        '<tr>',
        ...
        '</tr>',
        '<tr>',
        '<td>Personne (personne en chemise rose, personne enceinte)</td>',
        '<td>Homme, femme, fille, garçon, dames, messieurs, monsieur, madame (femmes enceintes, gars en chemise rose)</td>',
        '</tr>',
        '<tr>',
        '<td>La parentalité</td>',
        '<td>Maternité, paternité</td>',
        '</tr>',
        '<tr>',
        '<td>Femme assignée, homme assigné</td>',
        '<td>Femelle biologique, mâle biologique</td>',
        '</tr>',
        '<tr>',
        '<td>Cisgenre</td>',
        '<td>Non trans, normal, ou vrai</td>',
        '</tr>',
        '<tr>',
        '<td>Allaitement</td>',
        ...
        '</tr>',
        '<tr>',
        '<td>Hommes transgenres, femmes transgenres</td>',
        '<td>Un transexuel</td>',
        '</tr>',
        '<tr>',
        '<td>Préservatif externe, préservatif interne</td>',
        '<td>Préservatif masculin, préservatif féminin</td>',
        '</tr>',
        '<tr>',
        '<td>Sexe réceptif, sexe insertif</td>',
        '<td>Sexe vaginal</td>',
        '</tr>',
        '<tr>',
        '<td>Saignements mensuels</td>',
        '<td>Période, règles, menstruations</td>',
        '</tr>',
        '<tr>',
        '<td>Dépistage de santé sexuelle, examen interne, dépistage cervical</td>',
        '<td>Examen pelvien, examen de la femme, examen gynécologique</td>',
        '</tr>',
        '<tr>',
        '<td>Organes reproducteurs internes</td>',
        '<td>Organes reproducteurs féminins</td>',
        '</tr>',
        '<tr>',
        '<td>Gonades internes</td>',
        '<td>Ovaires</td>',
        '</tr>',
        '<tr>',
        '<td>Gonades externes</td>',
        '<td>Testules, testicules</td>',
        '</tr>',
        '<tr>',
        '<td>Organes génitaux internes, organes génitaux</td>',
        '<td>Vagin, vulve</td>',
        '</tr>',
        '<tr>',
        '<td>Organes génitaux externes, tissu érectile, organes génitaux</td>',
        '<td>Pénis</td>',
        '</tr>',
        '</table>',
      ],
...

    {
      ...
      content: [
        ...
        'Ces recommandations sont tirées de la <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/VCOP1.pdf"  target="_blank">Trousse d’outils pour les allié-es aux luttes autochtones</a> du Réseau stratégique urbain de la communauté autochtone de Montréal et du <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C104-1.pdf"  target="_blank">Guide pour les professionnels de la santé qui travaillent avec des client(e)s provenant de différentes communautés</a> d’Action Canada pour la santé et les droits sexuels.',
        '<h2>Conseils rapides pour les cliniciens:</h2>',
        '<ul>',
        '<li>Proposer des <strong>services de traduction</strong> et, si possible, des ressources traduites.',
        '<li>Établir des liens et revendiquer pour l’accès à des membres de la communauté autochtone de votre région qui peuvent agir en tant que navigateurs dans le système de santé.',
        '<li>Lorsqu’on entend parler d’expériences difficiles ou violentes de la part des personnes, affirmer leurs expériences et leur vécu. <strong>Éviter de les stigmatiser pour leurs sentiments ou la façon dont ils gèrent leurs émotions.</strong>',
        '<li><strong>Créer et maintenir une liste des ressources disponibles et de soutien culturel</strong> dans votre région, y compris les services sociaux.',
        '<li><strong>Les soutenir dans la création de leur propre plan de traitement</strong>, y compris l’intégration de ressources culturellement sécurisantes et méthodes de guérison traditionnelles.',
        '<li>Éviter de dire “Les peuples autochtones du Canada” ou “Nos peuples autochtones.” – <strong>Les peuples autochtones n’appartiennent pas au Canada ni à aucun individu.</strong>',
        '<li>Éviter de dire “La culture autochtone.” – <strong>Cette phrase ne reconnaît pas qu’il existe des centaines de communautés, nations, langues et cultures autochtones au Canada. Au lieu du singulier, essayer d’utiliser des formes plurielles comme “Les cultures autochtones” ou mieux encore, être précis sur la nation pour éviter la pan-indigénisation.</strong>',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<h2>Programme des services de santé non assurés (SSNA)</h2>',
        ...
        'Lien: <a class="ex" href="https://nihb-ssna.express-scripts.ca/en/0205140506092019/16/160407" target="_blank" >https://nihb-ssna.express-scripts.ca/en/0205140506092019/16/160407</a>',
        '<h2>Anciens Combattants Canada (ACC)</h2>',
        ...
        'Lien: <a class="ex" href="https://www.veterans.gc.ca/en/financial-programs-and-services/compensation-illness-or-injury/medical-costs/treatment-benefits#toc10" target="_blank" >https://www.veterans.gc.ca/eng/financial-support/medical-costs/coverage-services-prescriptions-devices#toc10</a>',
        '<h2>Services de santé des Forces canadiennes</h2>',
        ...
        'Lien: <a class="ex" href="http://www.cmp-cpm.forces.gc.ca/hs/en/drug-benefit-list/index.asp" target="_blank" >http://www.cmp-cpm.forces.gc.ca/hs/en/drug-benefit-list/index.asp</a>',
        '<h2>Programme de soins de santé de la Gendarmerie royale du Canada (GRC)</h2>',
        ...
        'Lien: <a class="ex" href="https://bc-cb.rcmp-grc.gc.ca/ViewPage.action?siteNodeId=2234&languageId=1&contentId=58416" target="_blank" >https://bc-cb.rcmp-grc.gc.ca/ViewPage.action?siteNodeId=2234&languageId=1&contentId=58416</a>',
        ...
        'Lien: <a class="ex" href="https://www.canada.ca/en/immigration-refugees-citizenship/services/refugees/help-within-canada/health-care/interim-federal-health-program/coverage-summary.html" target="_blank" >https://www.canada.ca/en/immigration-refugees-citizenship/services/refugees/help-within-canada/health-care/interim-federal-health-program/coverage-summary.html</a>',
        '<h2>Programmes du Service correctionnel du Canada (SCC)</h2>',
...

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www.ab.bluecross.ca/pdfs/pharmacy-benefacts/pharmacy-benefact-697.pdf" target="_blank" >https://www.ab.bluecross.ca/pdfs/pharmacy-benefacts/pharmacy-benefact-697.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www2.gov.bc.ca/gov/content/health/practitioner-professional-resources/pharmacare/pharmacies/plan-z" target="_blank" >https://www2.gov.bc.ca/gov/content/health/practitioner-professional-resources/pharmacare/pharmacies/plan-z</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www.gov.mb.ca/health/pharmacare/profdocs/csp_mifegymiso.pdf" target="_blank" >https://www.gov.mb.ca/health/pharmacare/profdocs/csp_mifegymiso.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www2.gnb.ca/content/gnb/en/departments/health/prescription-drug-plan/NBDrugPlan/ForHealthCareProfessionals/medical_abortion_claims_submission.html" target="_blank" >https://www2.gnb.ca/content/gnb/en/departments/health/prescription-drug-plan/NBDrugPlan/ForHealthCareProfessionals/medical_abortion_claims_submission.html</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www.gov.nl.ca/hcs/files/prescription-provider-guide-program-claiming-policies.pdf" target="_blank" >https://www.gov.nl.ca/hcs/files/prescription-provider-guide-program-claiming-policies.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien (voir pages 40/41): <a class="ex" href="https://www.hss.gov.nt.ca/en/services/mifegymiso-northwest-territories" target="_blank" >https://www.hss.gov.nt.ca/en/services/mifegymiso-northwest-territories</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien (voir page 41): <a class="ex" href="https://novascotia.ca/dhw/pharmacare/documents/Pharmacy-Guide.pdf" target="_blank" >https://novascotia.ca/dhw/pharmacare/documents/Pharmacy-Guide.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www.pharmacists.ca/cpha-ca/assets/File/cpha-on-the-issues/Mifegymiso_Access_Scan.pdf" target="_blank" >https://www.pharmacists.ca/cpha-ca/assets/File/cpha-on-the-issues/Mifegymiso_Access_Scan.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www.pharmacytechnologysolutions.ca/pharmaclik-rx-doc/Content/Resources/PDFs/ODBMifegymisoClaims.pdf" target="_blank" >https://www.pharmacytechnologysolutions.ca/pharmaclik-rx-doc/Content/Resources/PDFs/ODBMifegymisoClaims.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://www.princeedwardisland.ca/en/information/health-pei/abortion-services" target="_blank" >https://www.princeedwardisland.ca/en/information/health-pei/abortion-services</a>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Le médicament est fourni par un pharmacien qui a une entente particulière avec la Régie à cet effet.',
        '<li>La pharmacie est située dans une région frontalière au Québec.',
        '<li>Aucune pharmacie au Québec ne dessert la population dans un rayon de 32 kilomètres.',
        '</ul>',
        'Lien: <a class="ex" href="https://www.ramq.gouv.qc.ca/sites/default/files/documents/liste_med_2022-12-14_en_0.pdf" target="_blank" >https://www.ramq.gouv.qc.ca/sites/default/files/documents/liste_med_2022-12-14_en_0.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://formulary.drugplan.ehealthsask.ca/SearchFormulary" target="_blank" >https://formulary.drugplan.ehealthsask.ca/SearchFormulary</a>',
      ],
    },

    {
      ...
      content: [
        ...
        'Lien: <a class="ex" href="https://open.yukon.ca/sites/default/files/mt006-mIfe.pdf" target="_blank" >https://open.yukon.ca/sites/default/files/mt006-mIfe.pdf</a>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Confirmer que la décision appartient à la personne, prise sans contrainte.',
        '<li>Vérifier la date inscrite sur l’ordonnance ; si l’ordonnance a été rédigée 7 jours ou plus avant d’être apportée à la pharmacie, le pharmacien souhaitera peut-être faire un suivi auprès du prescripteur.',
        '<li>Souligner qu’en cas de grossesse évolutive après l’AM, une nouvelle dose de MISO ou un avortement par instruments est recommandé car la MIFÉ et le MISO sont tératogènes.',
        '<li>Exclure les contre-indications.',
        '<li>Examiner la date et l’heure auxquelles les personnes prévoient prendre le MIFÉ / MISO.',
        '<li>Revoir la date à laquelle la personne a un suivi avec leur prescripteur.',
        '</ul>',
        '<h2>S’assurer que la personne dispose des éléments suivants avant de partir[10]:</h2>',
        '<ul>',
        '<li>Serviettes et protections hygiéniques.',
        '<li>Médicaments contre la douleur et/ou contre la nausée (en vente libre ou sur ordonnance).',
        '<li>Accès aux soins d’urgence.',
        '<li>Aide à la garde d’enfants, au transport et à l’épicerie.',
        '</ul>',
        '<strong>S’assurer que les personnes comprennent comment administrer MIFÉ / MISO, comment gérer les effets secondaires, et savent quand et comment demander des soins</strong> (voir ci-dessous).',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Vérifier la bonne administration.',
        '<li>Examiner la gestion des effets secondaires.',
        '<li>Examiner les options de contraception.',
        '<li>Renforcer le suivi des professionnels de la santé.',
        '<li>Apporter un soutien émotionnel.',
        '</ul>',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Inducteurs du CYP3A4 (glucocorticoïdes, antibiotiques macrolides, rifampicine, carbamazépine, benzodiazépines, barbituriques, millepertuis)',
        '<li>Inhibiteurs du CYP3A4 (cimétidine, kétoconazole, érythromycine, chloramphénicol, spironolactone, sécobarbital, jus de pamplemousse).',
        '</ul>',
...

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><strong>Buccale</strong>: le délai jusqu’à la première contraction utérine est de 67 minutes, soutenu pendant environ 90 minutes et commence à diminuer 5 heures suivant l’administration. La réponse utérine semble similaire à celle de l’administration vaginale, avec moins de variabilité interindividuelle.',
        '<li><strong>Vaginale</strong>: le délai jusqu’à la première contraction utérine est de 82 minutes pour les comprimés secs et de 98 minutes pour les comprimés humidifiés, une activité soutenue est atteinte à 106 minutes et 128 minutes, respectivement. L’activité utérine commence à diminuer cinq heures après l’administration.',
        '<li><strong>Sublinguale</strong>: les comprimés sont absorbés par la muqueuse en 20 minutes et le MISO atteint sa concentration sérique maximale à 30 minutes. Le métabolisme de premier passage est évité.',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><strong>L’âge gestationnel</strong> est déterminé à l’aide des antécédents médicaux, d’un test urinaire ou βhCG sérique, ou d’une échographie. L’échographie n’est pas nécessaire pour déterminer l’âge gestationnel, sauf en cas d’incertiture de la date des dernières menstruations (DDM).[6,7].',
        '<li><strong>Une grossesse ectopique</strong> est exclue en utilisant les antécédents médicaux pour dépister les facteurs de risque et les symptômes. L’échographie est recommandée s’il existe des facteurs de risque importants ou des symptômes évocateurs d’une grossesse ectopique.[6,7].',
        '<li>Les ligne directrices pour <strong>le test et l’administration du facteur Rhésus (Rh)</strong> varient:',
        '<ul>',
        '<li>Ligne directrice clinique de La SOGC sur l’AM : le test Rh est recommandé lorsque l’âge gestationnel est supérieur à 47 jours[6].',
        '<li>Ligne directrice de télémédecine de La SOGC sur l’AM: le test Rh peut être suspendu jusqu’à 70 jours d’âge gestationnel[7].',
        '<li>Society of Family Planning: le test Rh n’est pas recommandé avant 12 semaines de gestation en cas d’avortement spontané, par médicaments ou par instruments[8].',
        '</ul>',
        '<li><strong>Une formule sanguine complète</strong> pour mesurer le taux d’hémoglobine est indiquée en cas de risque accru d’anémie ; sinon c’est inutile[7].',
        '<li>Une <strong>antibioprophylaxie</strong> de routine n’est pas nécessaire; le dépistage et le traitement au besoin constituent la stratégie de prise en charge privilégiée et est effectué par le prescripteur[6].',
        '</ul>',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li>Examiner les monographies de produit et les protocoles de délivrance de Mifégymiso.',
        '<li>Consulter les directives cliniques pour prescrire l’avortement par médicaments au besoin.',
        '<li>Se familiariser avec les règlements de votre ordre des pharmaciens provincial. Ce <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/PG1.pdf"  target="_blank">résumé</a> contient certains règlements spécifiques aux provinces, mais pas tous.',
        '<li>Préparer votre propre protocole et inviter d’autres membres du personnel à l’examiner et à fournir les commentaires.',
        '<li>Se familiariser avec les régimes d’assurance provinciaux et la couverture de Mifégymiso.',
        '<li>Explorer la volonté de délivrer le Mifégymiso parmi tout le personnel, y compris les assistants en pharmacie, les techniciens et les administrateurs de pharmacie, répondre à leurs préoccupations et à leurs possibles perceptions négatives, et déterminer la meilleure façon de lancer des services d’avortement dans votre pharmacie.',
        '<li>Examiner le personnel actuel de la pharmacie pour déterminer la capacité à fournir un AM.',
        '<li>Déterminer une personne ou une équipe clé qui aura la responsabilité principale des personnes ayant subi un AM.',
        '<li>Développer, imprimer et distribuer des affiches pour faire savoir aux clients et aux autres professionnels de la santé que vous distribuez Mifégymiso.',
        '</ul>',
        'Adapté de la <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C43.pdf"  target="_blank">Checklist for starting medical abortion services</a> de la Fédération Nationale de l’Avortement.',
      ],
    },

    {
      ...
      content: [
        ...
        '<ul>',
        '<li><a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C35.pdf"  target="_blank">Values clarification toolkits</a> de la Fédération Nationale de l’Avortement.',
        '<li>Matériel sur le <a class="in" href="https://caps.sogc.org/wp-content/uploads/2024/01/C58-10.pdf"  target="_blank">Values clarification workshop</a> du Reproductive Health Access Project.',
        '</ul>',
        '<li>Envisager de créer un comité de planification pour discuter des objectifs, des tâches, des échéanciers, des obstacles et des solutions.',
        '<li>Se renseigner sur d’autres centres de santé ou professionnels de la santé locaux qui ont intégré avec succès les services d’avortement dans leur pratique. Les inviter à des réunions, des ateliers et des séances de planification, ou solliciter leurs commentaires et conseils sur votre processus.',
        '<li>Élaborer un protocole pour les membres du personnel qui se sentent incapables de participer aux soins d’avortement.',
...

    {
      ...
      title: 'Medication',
      content: [
      '<strong>Q: When was the mifepristone (RU-486) / misoprostol drug regimen first approved in Canada? In other countries?</strong>',
      ...
      '<strong>Q: What is the approved MIFE200 / MISO800 dosing regimen in Canada?</strong>',
      ...
      '<strong>Q: If the person who consults me for a medication abortion has an absolute contraindication to using MIFE200 / MISO800, what are the other options for abortion?</strong>',
  ...
  },
  {
    ...
    content: [
      '<strong>Q: What topics should I cover in the initial pregnancy options counseling session with the person seeking abortion?</strong>',
      ...
      '<strong>Q: How can I support the patient emotionally after the abortion?</strong>',
...

{
  ...
  content: [
    '<strong>Q: What will a person experience during the medication abortion with mifegymiso?</strong>',
    ...
    '<strong>Q: What factors influence the pain experienced by the person during medication abortion?</strong>',
    ...
    '<strong>Q: What symptom management can I offer to the person who is undergoing a MIFE200 / MISO800 medication abortion?</strong>',
    ...
    '<strong>Q: How can I define “too much bleeding” to a person undergoing a medical abortion?</strong>',
    ...
    '<strong>Q: Should a pharmacist obtain a new prescription from the physician or nurse practitioner prescribing Mifegymiso if vomiting occurs within 30 minutes following a MISO dose?</strong>',
    ...
    '<ul>',
      '<li>If vomiting occurs during buccal absorption of MISO, contact prescriber for assessment. If there is not any bleeding within 48 hours of MISO administration, another dose may be required.',
      '<li>After swallowing MISO fragments 30 minutes after buccal administration: no action required; medication has already been absorbed.',
    '</ul>',
    '<strong>Q: How can I tell if my patient is experiencing toxic shock due to a clostridial infection?</strong>',
...

{
  ...
  title: 'Breastfeeding',
  content: [
    '<strong>Q: Can I give Mifegymiso to a woman who is breastfeeding?</strong>',
    ...
    '<strong><i>Mifepristone Summary of Use during Lactation (NLM):</i></strong>',
    ...
    '<strong><i>Misoprostol Summary:</i></strong>',
...

{
  ...
  content: [
    '<strong>Q: Can Mifegymiso be used for the termination of multiple gestation (i.e. twin pregnancy)? What’s the evidence / success?',
    ...
    '<ul>',
      '<li>Of 2208 subjects, 24 (1.1%) women had twins.',
      '<li>Treatment success was not statistically different for twin and singleton gestations (91% vs 97%, p = 0.19).',
      '<li>Perceived side effects, bleeding and pain were not statistically different between groups.',
    '</ul>',
...

{
  ...
  title: 'Methadone',
  content: [
    '<strong>Q: Is there an interaction between methadone and mifepristone?</strong>',
    '<i>A: Bottom Line:</i>',
...

{
  ...
  title: 'Médicaments',
  content: [
    '<strong>Q: Quand le régime mifépristone (RU-486) / misoprostol a-t-il été approuvé pour la première fois au Canada? Dans d’autres pays?</strong>',
    ...
    '<strong>Q: Quel est le schéma posologique approuvé pour MIFE 200 / MISO 800 au Canada?</strong>',
    ...
    '<strong>Q: Si la personne souhaitant un avortement par médicaments a une contre-indication absolue à l’utilisation de MIFE200 / MISO800, quelles sont les autres options d’avortement?</strong>',
    ...
    '<strong>Q: L’avortement par médicaments affecte-t-il la fertilité de la personne ou l’issue des grossesses futures?</strong>',
...
},
{
  ...
  title: 'Counseling',
  content: [
    '<strong>Q: Quels sujets devrais-je aborder lors de la séance initiale de counseling sur les options de grossesse avec la personne souhaitant avorter?</strong>',
    ...
    '<strong>Q: Comment puis-je soutenir émotionnellement la personne après l’avortement?</strong>',
...
},
{
  ...
  content: [
      '<strong>Q: Que ressentira une personne lors d’un avortement par médicaments avec Mifé-Miso?</strong>',
      ...
      '<strong>Q: Quels facteurs influencent la douleur qu’une personne ressent lors d’un avortement par médicaments?</strong>',
      ...
      '<strong>Q: Quels conseils pour la gestion des symptômes puis-je proposer à la personne qui subit un avortement par médicaments MIFE200 / MISO800?</strong>',
      ...
      '<strong>Q: Comment définit-on « trop de saignements » pour une personne qui a recours à un avortement par médicaments?</strong>',
      ...
      '<strong>Q: Un pharmacien devrait-il obtenir une nouvelle prescription du médecin ou de l’infirmière praticienne spécialisée qui a prescrit le Mifé-Miso, si des vomissements surviennent dans les 30 minutes suivant la prise de la dose de MISO?</strong>',
      ...
      '<ul>',
        '<li>En cas de vomissements lors de l’absorption buccale de MISO, contacter le prescripteur pour une évaluation. Si aucun saignement n’apparaît dans les 48 heures suivant l’administration de MISO, une autre dose peut être nécessaire.',
        '<li>Si vomissement des fragments de MISO 30 minutes après l’administration buccale : aucune action requise ; le médicament a déjà été absorbé.',
      '</ul>',
      '<strong>Q: Comment savoir si une personne subit un choc toxique dû à une infection à Clostridium?</strong>',
...
},
{
  ...
  title: 'Allaitement',
  content: [
    '<strong>Q: Le Mifé-Miso peut-il être administré à une femme qui allaite?</strong>',
    ...
    '<strong><i>Résumé de l’utilisation de la mifépristone pendant l’allaitement (NLM):</i></strong>',
    ...
    '<strong>Niveaux de médicaments:</strong>',
...
},
{
  ...
  content: [
    '<strong>Q: Mifé-Miso peut-il être utilisé pour interrompre une grossesse multiple (c’est-à-dire une grossesse gémellaire)? Quelles sont les preuves / le taux de réussite?</strong>',
    ...
    '<ul>',
      '<li>Sur 2 208 sujets, 24 (1,1 %) femmes ont eu des jumeaux.',
      '<li>Le succès du traitement n’était pas statistiquement différent pour les grossesses gémellaires et uniques (91 % contre 97 %, p = 0,19).',
      '<li>Les effets secondaires perçus, les saignements et la douleur n’étaient pas statistiquement différents entre les groupes.',
    '</ul>',
...
},
{
  ...
  title: 'Methadone',
  content: [
    '<strong>Q: Y a-t-il une interaction entre la méthadone et la mifépristone?</strong>',
    '<i>R: Conclusion:</i>',
    ...
    '<i>Il n’y a actuellement aucune littérature indiquant que les personnes sous méthadone ont des expériences meilleures ou pires avec la RU486 comme abortif, à l’exception des deux points suivants : (1) elles peuvent être plus susceptibles d’être exposés à des difficultés à suivre le traitement tel qu’indiqué et pourraient donc déclarer avoir pris le médicament sans l’avoir fait, et (2) il existe des rapports contradictoires concernant les effets de la méthadone sur le rythme cardiaque (fait étrange) et qu’associée à la mifépristone pourrait provoquer des arythmies graves.</i>',
